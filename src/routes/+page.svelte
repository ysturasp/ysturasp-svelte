...
<svelte:head>
	<title>ysturasp | Спорим, это твой помощник для учебы в ЯГТУ?</title>
	<meta
		name="description"
		content="ysturasp - помощник для учебы в ЯГТУ. Расписание занятий, статистика оценок, информация о кампусе и другие полезные сервисы для студентов"
	/>
	<meta
		name="keywords"
