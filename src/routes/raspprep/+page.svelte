...
<svelte:head>
	<title>Расписание преподавателей ЯГТУ | Поиск по преподавателям</title>
	<meta
		name="description"
	...
	<meta property="og:title" content="Расписание преподавателей ЯГТУ | Поиск по преподавателям" />
	<meta
